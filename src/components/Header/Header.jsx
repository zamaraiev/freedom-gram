      ...
      <header className='app-header'>
        <nav className='menu'>
           ...
           <ul>
               ...
               <li><NavLink className='menu__link link' to='/search'><img className='menu__link_img' alt='messege' src={SearchIcon}></img>Пошук</NavLink></li>
               ...
               <li><NavLink className='menu__link link' to='/setting'><img className='menu__link_img' alt='profile' src={SettingIcon}></img>Налаштування</NavLink></li>
